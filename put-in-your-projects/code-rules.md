...
- Jangan asumsikan stack di luar `[STACK_BACKEND]`/`[STACK_FRONTEND]` kecuali task membuktikan ada integrasi terpisah.
...
- Gunakan migration/mekanisme schema resmi untuk perubahan struktur `[DATABASE]`, bukan edit manual tanpa jejak.
...
## 6. Integrasi eksternal `[INTEGRASI_EKSTERNAL]`
