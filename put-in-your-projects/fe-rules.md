...
## Aturan revisi
Jika hasil masih terasa template AI, terlalu marketing, atau tidak cocok dengan pola project, revisi sampai lebih natural, operasional, dan konsisten dengan `[STACK_FRONTEND]`.
