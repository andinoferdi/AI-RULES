...
- Jika RTK tersedia, awali shell command dengan `rtk` (contoh: `rtk git status`, `rtk [PERINTAH_BUILD]`). Untuk cmdlet/built-in yang tidak bisa dijalankan RTK langsung, gunakan `rtk proxy [SHELL] -Command "..."`.
