...
- Integrasi eksternal `[INTEGRASI_EKSTERNAL]` punya timeout, error handling, logging aman, dan fallback.
...
## Aturan revisi
Jika solusi terlalu generik atau keluar dari pola project, revisi sampai sesuai stack, pola file, kontrak data, permission, dan kebutuhan bisnis `[PROJECT_NAME]`.
